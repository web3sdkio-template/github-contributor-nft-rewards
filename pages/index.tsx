import { useContract, Web3Button } from "@web3sdkio/react";
...
const Home: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        Claim an NFT if you have contributed to any of web3sdkio&apos;s repos.
      </p>
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  const web3sdkioUser = await getUser(context.req);
